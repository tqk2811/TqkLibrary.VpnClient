...
/// <summary>Byte-exact packet builders used by the SIIT tests (reusing the IpStack codecs).</summary>
static class TestPackets
{
    ...
    public static byte[] UdpSegment(IPAddress src, IPAddress dst, ushort sport, ushort dport, byte[] data, bool zeroChecksum = false)
    {
