...
| `Ikev2ReconnectOptions` | **kế thừa** [`VpnReconnectOptions`](../TqkLibrary.VpnClient.Drivers.Core/Models/VpnReconnectOptions.cs#L14) (F.6): `Enabled`/`MaxAttempts`/backoff/jitter — IKEv2 không thêm knob, giữ named type cho public API | — IKEv2 không thêm knob, giữ named type cho public API | [Ikev2ReconnectOptions.cs:12](Ikev2ReconnectOptions.cs#L12) |
