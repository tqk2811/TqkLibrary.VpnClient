...
{
    /// <summary>
    /// What an <see cref="IEoGreTransportFactory"/> hands back: the UDP datagram pipe the data plane rides
    ...
    /// is <c>null</c>. The pipe is disposed when the attempt ends. Mirrors <c>GeneveTransportHandle</c>.
    /// </summary>
    public sealed class EoGreTransportHandle
    {
        /// <summary>Creates a handle around <paramref name="datagram"/>.</summary>
        public EoGreTransportHandle(IDatagramTransport datagram,
        ...
        /// <summary>The UDP datagram pipe (one datagram = one GRE-in-UDP datagram; there is no framing).</summary>
