...
> **Mọi protocol driver** (17 driver) nay đã migrate sang base (F.6 hoàn tất); chỉ `SstpReconnectOptions` thêm knob riêng (`ReadTimeout`), các driver còn lại giữ named-type rỗng để không vỡ public API.
