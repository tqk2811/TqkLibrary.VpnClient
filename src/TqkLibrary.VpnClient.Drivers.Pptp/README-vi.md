...
- **Được dùng bởi:** [TqkLibrary.VpnClient](../TqkLibrary.VpnClient) (entry point — [`VpnClientBuilder.UsePptp(IRawIpTransportFactory, ...)`](../TqkLibrary.VpnClient/VpnClientBuilder.cs#L107) đăng ký driver này).
