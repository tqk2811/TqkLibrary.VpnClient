...
{
    /// <summary>
    /// The Geneve driver's auto-reconnect / backoff options. Derives from the shared <see cref="VpnReconnectOptions"/> so
    ...
    /// </summary>
    public sealed class GeneveReconnectOptions : VpnReconnectOptions
    {
    }
}
