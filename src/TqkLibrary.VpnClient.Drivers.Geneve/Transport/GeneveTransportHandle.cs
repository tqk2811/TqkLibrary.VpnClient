...
{
    /// <summary>
    /// What an <see cref="IGeneveTransportFactory"/> hands back: the UDP datagram pipe the data plane rides
    ...
    /// is <c>null</c>. The pipe is disposed when the attempt ends. Mirrors <c>VxlanTransportHandle</c>.
    /// </summary>
    public sealed class GeneveTransportHandle
    {
        /// <summary>Creates a handle around <paramref name="datagram"/>.</summary>
        public GeneveTransportHandle(IDatagramTransport datagram,
        ...
        /// <summary>The UDP datagram pipe (one datagram = one Geneve datagram; Geneve has no framing).</summary>
