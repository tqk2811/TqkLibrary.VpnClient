...
- **Còn lại (V.8 ngoài phase a):** **(b) driver** raw socket gửi/nhận theo proto-number → ráp các kênh này (cần [`Transport.RawIp`](../TqkLibrary.VpnClient.Transport.RawIp) + elevate); **EtherIP** (proto-97, ghép [Ethernet L2](../TqkLibrary.VpnClient.Ethernet)) + **L2TPv3-over-IP** (proto-115); **(c) validate live** (cần IP public — NAT chặn proto lạ, lab Q.1).
