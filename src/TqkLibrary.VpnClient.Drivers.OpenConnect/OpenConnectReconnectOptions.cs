namespace TqkLibrary.VpnClient.Drivers.OpenConnect
{
    ...
    /// dead, or a transport fault). Enabled by default; set <see cref="Enabled"/> to false to keep single-shot
    /// behaviour. Mirrors the WireGuard/OpenVPN/IKEv2/L2TP driver policies so the shared supervisor (roadmap F.6) can
    /// later subsume all of them.
    /// </summary>
    public sealed class OpenConnectReconnectOptions
    {
