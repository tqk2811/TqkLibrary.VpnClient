...
> IPsec: ESP transform (RFC 4303) dưới `Esp/`, IKE dưới `Ike/` — IKEv1 Main+Quick Mode (`Ike/V1`) và IKEv2 (`Ike/V2`) — NAT-T UDP framing/channel (RFC 3948, cổng 500/4500) dưới `Nat/`, và codec nén payload IP (IPComp, RFC 3173 DEFLATE) dưới `IpComp/`.
