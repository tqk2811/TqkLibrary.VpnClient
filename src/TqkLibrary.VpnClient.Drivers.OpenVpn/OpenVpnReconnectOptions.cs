namespace TqkLibrary.VpnClient.Drivers.OpenVpn
{
    ...
    /// fault). Enabled by default; set <see cref="Enabled"/> to false to keep single-shot behaviour. Mirrors the
    /// IKEv2/L2TP driver policies so the shared supervisor (roadmap F.6) can later subsume all three.
    /// </summary>
    public sealed class OpenVpnReconnectOptions
    {
