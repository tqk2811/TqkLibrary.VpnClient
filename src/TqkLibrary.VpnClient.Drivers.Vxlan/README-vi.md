...
| `VxlanConnectionState` / `VxlanReconnectOptions` | `Disconnected/Connecting/Connected/Reconnecting` + kế thừa `VpnReconnectOptions` (F.6) | [Enums/VxlanConnectionState.cs:4](Enums/VxlanConnectionState.cs#L4) / [VxlanReconnectOptions.cs:10](VxlanReconnectOptions.cs#L10) |
